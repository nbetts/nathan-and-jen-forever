    ...
    return (
      <div className="card">
        <div className="card-body">
          ...
          <button className={`btn btn-outline-pink my-3 ${newChanges ? 'mr-2' : 'd-none'}`} type="button" onClick={this.undoList}>Undo</button>
          <button className={`btn btn-outline-pink my-3 ${newChanges ? '' : 'd-none'}`} type="button" onClick={this.saveChanges}>Save Changes</button>
